...
function Toolbox() {
	...
	this.selectTool = function(toolName) {
		...
		if (this.selectedTool.name === "stampTool") {
			select("#sizeOfStamps").show();
			select("#numberOfStamps").show();
			select("#stampStyle").show();
		} 
		else {
			select("#sizeOfStamps").hide();
			select("#numberOfStamps").hide();
			select("#stampStyle").hide();
		}

		if (this.selectedTool.name === "eraserTool") {
			select("#sizeOfEraser").show();
		} 
		else {
			select("#sizeOfEraser").hide();
		}
		...
		if (this.selectedTool.name === "kaleidoscope") {
			select("#symmetry").show();
		}
		else {
			select("#symmetry").hide();
		}
	};
